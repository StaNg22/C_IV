...
namespace CHUONG_III
{
    class Bai_03_CHUONG_III
    {
        static void Main()
        {
            ...
            t = double.Parse(Console.ReadLine());//nhập điểm toán từ bàn phím

            Console.WriteLine("Nhập vào điểm Lý:");
            l = double.Parse(Console.ReadLine());//nhập điểm lý từ bàn phím

            Console.WriteLine("Nhập vào điểm Hóa:");
            h = double.Parse(Console.ReadLine());//nhập điểm hóa từ bàn phím
