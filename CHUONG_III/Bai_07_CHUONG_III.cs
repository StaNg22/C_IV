      ...
      static void Main()
        {
            ...
            {
                p = (a - s) % 60;//vd: a=3601 => s=1 =>p=(3601 - 1)%60[chia lấy phần dư] = 1
                h = a / 3600;//vd: a=3601 =>h=3601/3600(chia lấy phần nguyên) = 1
                if (h < 10 && p < 10 && s < 10)//vd: h=1 và p=1 và s=1 => 01:01:01
                {

                    //output
                    Console.WriteLine($"Giờ được chuyển đổi là: 0{h}:0{p}:0{s}");//in ra kết quả
                }
                else if (h < 10 && p < 10)
                {

                    //output
                    Console.WriteLine($"Giờ được chuyển đổi là: 0{h}:0{p}:{s}");//in ra kết quả
                }
                else if (h < 10 && s < 10)//vd: h=1 và p=11 và s=1 =>01:11:01
                {

                    //output
                    Console.WriteLine($"Giờ được chuyển đổi là: 0{h}:{p}:0{s}");//in ra kết quả
                }
                else if (p < 10 && s < 10)//vd: h=11 và p=1 và s=1 =>11:01:01
                {

                    //output
                    Console.WriteLine($"Giờ được chuyển đổi là: {h}:0{p}:0{s}");//in ra kết quả
                }
                else if (h < 10)//vd: h=1 và p=11 và s=1 =>01:11:11
                {

                    //output
                    Console.WriteLine($"Giờ được chuyển đổi là: 0{h}:{p}:{s}");//in ra kết quả
                }
                else if (p < 10)//vd: h=11 và p=1 và s=11 =>11:01:11
                {

                    //output
                    Console.WriteLine($"Giờ được chuyển đổi là: {h}:0{p}:{s}");//in ra kết quả
                }
                else if (s < 10)//vd: h=11 và p=11 và s=1 =>11:11:01
                {

                    //output
                    Console.WriteLine($"Giờ được chuyển đổi là: {h}:{p}:0{s}");//in ra kết quả
                }
                else//vd: h=11 và p=11 và s=11 =>11:11:11
                {

                    //output
                    Console.WriteLine($"Giờ được chuyển đổi là: {h}:{p}:{s}");//in ra kết quả
                }
            }
        }
    }
